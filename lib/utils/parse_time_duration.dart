  ...
  class ParseTimeDuration{


    static String toStringTimeVideo(String durationISO){
      final time=_toDuration(durationISO);
      return _format(time);

    }

    static _format(Duration d) => d.toString().split('.').first.padLeft(8, "0");
